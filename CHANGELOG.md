...
- **misc**: Replace lodash-es with es-toolkit and move docs components.
...
- **misc**: Replace lodash-es with es-toolkit and move docs components, closes [#6](https://github.com/lobehub/fluent-emoji/issues/6) ([4dde5e8](https://github.com/lobehub/fluent-emoji/commit/4dde5e8))
